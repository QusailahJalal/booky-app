...
extension WidgetExtensions on Widget {
  Widget paddingAll([double value = 8.0]) =>
      Padding(padding: EdgeInsets.all(value.sp), child: this);
  Widget paddingSymmetric({double horizontal = 8.0, double vertical = 0.0}) =>
      Padding(
  ...
  Widget onTap(void Function()? onTap) => InkWell(onTap: onTap, child: this);
}
